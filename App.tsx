    ...
    <div className="min-h-screen flex flex-col selection:bg-orange-100 selection:text-orange-900">
      ...
      <footer className="relative text-white overflow-hidden bg-[#111E6C] border-t border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] gap-12 lg:gap-16">
            <div className="space-y-8">
              <div className="flex items-center gap-4 cursor-pointer group" onClick={() => navigate('home')}>
                <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shadow-xl group-hover:scale-105 group-hover:bg-white/10 transition-all duration-300">
            ...
            <div>
              <h4 className="text-white font-[900] text-xs uppercase tracking-[0.3em] mb-10 flex items-center gap-4 opacity-80">
                <span className="w-8 h-px bg-[#FF8C00]"></span> KHÁM PHÁ
              </h4>
                ...
                {[
                  ...
                  <li key={link.id}>
                    <button 
                      ...
                      className="text-blue-100/50 hover:text-white font-bold text-lg transition-all flex items-center gap-4 group text-left"
                    >
            ...
            <div>
              <h4 className="text-white font-[900] text-xs uppercase tracking-[0.3em] mb-10 flex items-center gap-4 opacity-80">
                <span className="w-8 h-px bg-[#FF8C00]"></span> TÀI LIỆU
              </h4>
              <ul className="space-y-6">
                {['Cẩm nang tuyển sinh', 'Blog hướng nghiệp', 'Thống kê thị trường'].map((label) => (
                  <li key={label}>
                    <a href="#" className="text-blue-100/50 hover:text-white font-bold text-lg transition-all flex items-center gap-4 group">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FF8C00] scale-0 group-hover:scale-100 transition-transform"></div>
                      {label}
                    </a>
                  </li>
            ...
            <div>
              <h4 className="text-white font-[900] text-xs uppercase tracking-[0.3em] mb-10 flex items-center gap-4 opacity-80">
                <span className="w-8 h-px bg-[#FF8C00]"></span> KẾT NỐI
              </h4>
              <div className="space-y-10">
                ...
                >
                  <div className="mt-1.5 w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0 border border-white/10 group-hover:bg-[#FF8C00] group-hover:border-[#FF8C00] transition-all shadow-sm">
                    <Mail className="w-5 h-5 text-[#FF8C00] group-hover:text-white transition-colors" />
                  </div>
                  <div className="space-y-0.5">
                    <p className="text-[#FF8C00] uppercase text-[10px] tracking-[0.2em] font-black group-hover:text-white transition-colors">EMAIL</p>
                    <p className="text-white font-extrabold text-lg lg:text-xl break-all group-hover:underline underline-offset-4 decoration-[#FF8C00]/30 transition-all">
                      contact@oriemap.ai
                    </p>
                  </div>
                </a>
                ...
                <div className="flex gap-4 pt-4">
                  {[
                    ...
                    <a 
                      ...
                      className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#FF8C00] hover:text-white hover:bg-[#FF8C00] hover:border-[#FF8C00] transition-all duration-300 shadow-lg"
                    >
          ...
          <div className="mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-blue-100/30 font-bold text-sm">© 2024 Orie Map AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
